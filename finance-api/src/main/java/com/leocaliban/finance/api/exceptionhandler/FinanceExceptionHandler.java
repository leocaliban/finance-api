...
public class FinanceExceptionHandler extends ResponseEntityExceptionHandler{
	...
	/**
	 * Método que trata a exceção DataIntegrityViolationException que ocorre quando se tenta salvar um recurso informando o código inexistente de
	 * sua entidade relacionamento 
	 * @param ex exceção
	 * @param request requisição
	 * @return entidade de resposta para o usuário
	 */
